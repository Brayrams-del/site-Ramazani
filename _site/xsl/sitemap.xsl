  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      <head>
        ...
        <title>Sitemap - Grace vayisiriria kamabale</title>
        <style type="text/css">
          html {
            margin: 0;
            padding: 0;
      ...
      <body>
        <h1>List of URLs for <a href="https://gracevayisiriria.github.io/ProjetCecile/">Grace vayisiriria kamabale</a>:</h1>
        <form>
          ...
          <input id="feed-url" onClick="this.select();">
            ...
            <xsl:attribute name="value">https://gracevayisiriria.github.io/ProjetCecile/sitemap.xml</xsl:attribute>
          </input>
        </form>
        <ol>
